...
<head>
    ...
    <title>Laporan Item - Sarpras Sekolah</title>
...
<div class="d-flex">
    <!-- Sidebar -->
    @include('sidebar', ['active' => 'laporanitem'])

    <!-- Main content -->
    <div class="flex-grow-1">
        <nav class="navbar navbar-expand-lg navbar-light bg-light px-4">
            <div class="container-fluid">
                <span class="navbar-brand mb-0 h1">Halaman Laporan Item</span>
                <div class="d-flex">
        ...
        <div class="content">
            ...
            <div class="mb-3">
                <a href="{{ route('laporanitem.export') }}" class="btn btn-success">
...
<script>
    $(document).ready(function () {
        $('#laporanTable').DataTable({
            order: [[1, 'asc']] // Urutkan berdasarkan nama item
        });
    });
</script>
