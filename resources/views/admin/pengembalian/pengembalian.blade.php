...
<head>
    ...
    <title>Pengembalian - Buku Librinet</title>
            ...
            <table id="pengembalianTable" class="table table-bordered table-striped nowrap" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>Buku</th><th>Jumlah</th><th>Tgl Pinjam</th><th>Tgl Kembali</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $pengembalian->buku->nama ?? 'Buku telah dihapus' }}</td>
                        ...
                        @if ($pengembalian->admin_id === null)
                            <td>
                                <form action="{{ route('pengembalian.approve', $pengembalian->id) }}" method="POST" class="d-flex gap-2">
                                    @csrf
                                    @method('PATCH')
                                    <select name="kondisi_buku" class="form-control form-control-sm" required>
                        ...
                        @else
                            <td>{{ ucfirst($pengembalian->kondisi_buku) }}</td>
